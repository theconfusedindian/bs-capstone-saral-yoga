      ...
      <div className="aboutPage__wrapper">
        ...
        <article className="aboutPage__intro">
          <p>
            ...
            behind it is so strong and often overlooked in our practice, but
            that is what fascinates me. I like reading The Yoga Sutras and I
            believe there's something I learn everyday from it.
          </p>
          <p>
            I believe there's a time for everything, and when the time is right
            the opportunity will present itself. I put off teaching for many
            years because of my own insecurities. However, I feel ready at this
            point in my life and I am learning to believe in myself and embrace
            my vulnerability which is what Yoga is all about.
          </p>
          <p>
        ...
        <div className="aboutPage__comments">
          ...
          <form className="aboutPage__review" onSubmit={handleOnSubmit}>
            ...
            <div className="aboutPage__review--button">
              ...
              <button
                type="submit"
                className="aboutPage__review--button--submit"
              >
                <h3>Submit</h3>
              </button>
            </div>
